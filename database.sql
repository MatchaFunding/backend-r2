...
BEGIN
	...
	SELECT ID FROM Region WHERE al=Nombre INTO alcance;
...
CALL CrearInstrumento ('Innova Alta Tecnología – Eureka','','Apoyamos innovaciones intensivas en I+D, que enfrenten alta incertidumbre tecnológica y que apunten a escalamientos de alto potencial de comercialización nacional o global, fortaleciendo las capacidades de I+D+i en las empresas.','2025-01-01','2025-12-31',0,'InnovaChile cofinanciará los proyectos que resulten adjudicados con un tope de hasta $1.000.000.000.- (mil millones de pesos). El porcentaje de cofinanciamiento dependerá de los ingresos anuales por ventas del beneficiario: Empresa Micro y pequeña (ventas por hasta 25.000 UF anual): hasta 70%. Empresa Mediana (ventas por sobre 25.000 UF y hasta 100.000 UF anual) hasta 55%. Empresa Grande (ventas por sobre 100.000 UF anual) hasta 40%. Aumento de hasta un 10 % más de cofinanciamiento para ‘Empresas lideradas por mujeres’. Beneficio para PYMES que cuenten con el ‘Sello 40 horas’','',0,1000000000,'EVA','RIE','EMP','https://corfo.cl/sites/cpp/convocatoria/innova_alta_tecnologia_eureka/','',2);
...
CALL CrearInstrumento ('Innova Región Atacama 2025','AT','Apoyamos el desarrollo de nuevos o mejorados productos (bienes o servicios) y/o procesos desde la fase de prototipo, hasta la fase de validación técnica a escala productiva y/o validación comercial, que aporten a la economía regional y fortalezcan las capacidades de innovación en la empresa en los ámbitos minería, agroindustria, eficiencia hídrica y energética.','2025-01-01','2025-12-31',0,'Se cofinanciará los proyectos con un tope de hasta $60.000.000.- (sesenta millones de pesos). Se financiará un porcentaje del costo total del proyecto, dependiendo de los ingresos por ventas del beneficiario: Empresa Micro y pequeña (ventas por hasta 25.000 UF anual): hasta 80% Empresa Mediana (ventas por sobre 25.000 UF y hasta 100.000 UF anual) hasta 60% Empresa Grande (ventas por sobre 100.000 UF anual) hasta 40% Aumento de hasta un 10 % más de cofinanciamiento para \"Empresas lideradas por mujeres\".','Tener RUT chileno, Ser persona natural o jurídica, Estar insrito en un programa x',0,60000000,'EVA','CAP','EMP','https://corfo.cl/sites/cpp/convocatoria/innova-region-atacama-2025/','',2);
